...
CMIP6 is the latest in a long history of internationally coordinated and scientifically collaborative climate model-based research projects. It developed standard approaches to evaluate and intercompare climate models, and a standardised vocabulary and infrastructure that defined and delivered the data to a broad and expanding community. This arrangement ensures that projections of future climate conditions are based on a robust and consistent framework.

The progress embedded in the latest phase marks 35 years since coordinated MIP activities began at an informal meeting of experts focused on modelling standards and climate model intercomparison in Boulder, Colorado, August 1989, which became the first MIP, AMIP1 \citep{gates_amip_1991}. Since this foundational work, MIPs have captivated and engaged a broad and growing community and had a tangible impact, improving our knowledge of Earth's climate system.
...
The CMIP project has had a sustained global impact. Its success has depended on the continuing efforts of tenacious individuals or small teams that initiated the steps facilitating community engagement. These initial efforts, coupled with the coordinated efforts within and across modelling groups, the infrastructure providers, and other contributors, led to the broad community collaboration and coordination which realised CMIP's ongoing impact. At its core, the project is a fundamental anchor point of international climate research, facilitating modelling groups to generate the best possible simulations aiding climate change planning. In return, modelling groups benefit from coordinated, collaborative activities and community evaluation, which feeds back on the climate model development process, embodying the statement, "intercomparison makes for a better climate model."
