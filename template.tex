...
\begin{itemize}
    ...
    \item \textbf{Ag Stephens, Alan Iwi, (\underline{Phil Kershaw}) CEDA}: ESGF; \autoref{sec:earthSystemGridFederation}
...
GridFTP & an extension of FTP for grid computing; \url{https://www.globus.org/blog/gridftp-a-brief-history-of-fast-file-transfer}\\ \hline
