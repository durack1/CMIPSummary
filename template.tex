...
\Author[11]{and past/present members of the}{WGCM Infrastructure Panel (WIP), CMIP Panel, and Earth System Grid Federation (ESGF)}
...
\affil[11]{C/o PCMDI, LLNL, Livermore, California, USA}
...
\cred{The main request from the modeling centers after CMIP5 was the need for a data citation possibility that can be included in the IPCC AR6. This led to the development and implementation of the citation service. And CMIP6 data could be cited in the WGI AR6 for the first time in the history of CMIP.}
