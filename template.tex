...
\cred{
\begin{itemize}
    \item \textbf{\sout{Jiwoo Lee}, \sout{Curt Covey}, Ken Sperber, Ben Santer, Charles Doutriaux, Tom Phillips, PCMDI}: (\autoref{sec:cmip6InContext}: A/CMIP history, \autoref{sec:CMIP6SupportingProjects-CoordEval}: Coordinated evaluation);
...
\begin{figure}
    \centering
    \includesvg[width=1\linewidth]{241115T170138_Fig1.svg}
...
Observations are 
Obs4MIPs was established to facilitate climate model evaluation via technical alignment of gridded observational products with CMIP protocols. This is accomplished by metadata/data integration of the two  projects,  facilitating  side-by-side  delivery  of  both  via  ESGF.  The project originated with a collaboration between PCMDI and NASA (\citep{gleckler_improving_2011,teixeira_satellite_2014}), and was later internationalized by the WCRP Data Advisory Council (WDAC). A workshop helped identify key community recommendations to advance obs4MIPs (Ferraro et al., 2015), many of which are still relevant and being addressed today.  A detailed status of obs4MIPs during the CMIP6 evaluation phase was documented in \citep{waliser_observations_2020}.  More recently, obs4MIPs has been revitalized with support of the CMIP IPO, and  
...
\begin{figure*}
    \centering
    \includesvg[width=\textwidth]{241115T170138_Fig5.svg}
