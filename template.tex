...
\Author[10,18]{Sylvie}{Joussaume} % 0000-0002-1510-3964
\Author[10,17]{Guillaume}{Levavasseur} % 0000-0002-0801-0890
\Author[10,18]{Atef}{Ben-Nasser} % 0000-0001-6948-8735
\Author[10,17]{Sven}{Rodriguez} % ?
...
\affil[10]{Institut Pierre Simon Laplace (IPSL), Paris, France}
...
\affil[17]{Sorbonne University (SU), Paris, France}
\affil[18]{Centre National de Recherche Scientifique (CNRS), Paris, France}
...
\begin{itemize}
    ...
    \item \textbf{\sout{Bryan Lawrence}, \underline{David Hassell}, UReading}; \underline{Eric Guilyardi}, IPSL (\autoref{sec:ModelDocumentation}: Model (and data) documentation);
    \item \textbf{\underline{Guillaume Levavasseur}, \underline{Atef Ben-Nasser}, IPSL} (\autoref{sec:CMIPErrata}: CMIP errata);
...
\begin{itemize}
    ...
    \item \textbf{\sout{Dean Williams}, \sout{Bryan Lawrence}, \underline{Jonathan Gregory}} (\autoref{sec:CMIPSupportingOrgsAndInfra}: ESGF/CF);
    ...
    \item \textbf{\underline{Balaji V.}, \sout{Sebastien Denvil}, \underline{Luca Cinquini}, Mark Elkington, \underline{Eric Guilyardi}, Michael Lautenschlager, \underline{Ruth Petrie}, \sout{Dean Williams}}: WIP Panel
