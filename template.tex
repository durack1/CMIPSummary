...
\Author[1,2]{Paul J.}{Durack} % ORCID 0000-0003-2835-1438
\Author[1]{Karl E.}{Taylor} % 0000-0002-6491-2135
\Author[1]{Peter J.}{Gleckler} % 0000-0003-2816-6224
\Author[3]{Gerald A.}{Meehl} % 0000-0002-8760-9534
\Author[4]{Bryan N.}{Lawrence} % 0000-0001-9262-7860
\Author[1]{Curt}{Covey} % 0000-0002-0016-7199
\Author[5]{Ronald J.}{Stouffer} % 0000-0002-7900-6290
\Author[6,7]{Guillaume}{Levavasseur} % 0000-0002-0801-0890
\Author[6,8]{Atef}{Ben-Nasser} % 0000-0001-6948-8735
\Author[9,a]{Sebastien}{Denvil} % 0000-0002-6715-3533
\Author[10]{Martina}{Stockhause} % 0000-0001-6636-4972
\Author[4,11]{Jonathan M.}{Gregory} % 0000-0003-1296-8644
\Author[12,13]{Martin}{Juckes} % 0000-0003-1770-2132
\Author[14]{Ian T.}{Foster} % 0000-0003-2129-5269
%---
\Author[1]{Sasha K.}{Ames} % 0000-0001-9981-2997
\Author[15]{Fabrizio}{Antonio} % 0000-0002-7693-0111
\Author[1]{David C.}{Bader} % 0000-0003-3210-339X
\Author[16]{John P.}{Dunne} % 0000-0002-8794-0489
\Author[17]{Daniel}{Ellis} % 0000-0001-6733-7028
\Author[18,19]{Veronika}{Eyring} % 0000-0002-6887-4885
\Author[20,b]{Sandro L.}{Fiore} % 0000-0002-8430-6087
\Author[6,8]{Sylvie}{Joussaume} % 0000-0002-1510-3964
\Author[21,13]{Philip}{Kershaw} % 0000-0002-7646-291X
...
\Author[11]{Matthew}{Mizielinski} % 0000-0002-3457-4702
\Author[15]{Paola}{Nassisi} % 0000-0003-2857-4391
\Author[15]{Alessandra}{Nuzzo} % 0000-0002-8801-6917
\Author[17]{Eleanor}{O'Rourke} % 0000-0002-0775-0811
\Author[e,f]{Jeffrey}{Painter} % 0000-0001-7920-4337
\Author[e]{Gerald L.}{Potter} % 0000-0003-0291-7229
\Author[6,7]{Sven}{Rodriguez} % 0009-0000-4283-3228
...
\affil[2]{Oceans Institute, University of Western Australia (UWA), Crawley, Perth, Western Australia, Australia}
\affil[3]{National Center for Atmospheric Research (NCAR), Boulder, Colorado, USA}
\affil[4]{NCAS, Department of Meteorology, University of Reading, Reading, UK}
\affil[5]{The University of Arizona (UA), Tucson, Arizona, USA}
\affil[6]{Institut Pierre Simon Laplace (IPSL), Paris, France}
\affil[7]{Sorbonne University (SU), Paris, France}
\affil[8]{Centre National de Recherche Scientifique (CNRS), Paris, France}
\affil[9]{European Centre for Medium-Range Weather Forecasts (ECMWF), Reading, UK}
\affil[10]{German Climate Computing Center (DKRZ), Hamburg, Germany}
\affil[11]{Met Office (MOHC), Exeter, UK}
\affil[12]{Kellogg College, University of Oxford, Oxford, UK}
\affil[13]{UK Research and Innovation (UKRI) Science \& Technology Facilities Council (STFC), Oxfordshire, UK}
\affil[14]{Argonne National Laboratory (ANL), Lemont, Illinois, USA}
%---
\affil[15]{CMCC Foundation - Euro-Mediterranean Center on Climate Change (CMCC), Lecce, Italy}
\affil[16]{Geophysical Fluid Dynamics Laboratory, National Oceanic \& Atmospheric Administration (NOAA-GFDL), Princeton, New Jersey, USA}
\affil[17]{CMIP International Project Office (CMIP-IPO); European Space Agency Centre for Space Applications \& Telecommunications (ESA-ECSAT), Oxfordshire, UK}
\affil[18]{Deutsches Zentrum f{\"u}r Luft- und Raumfahrt (DLR), Institut f{\"u}r Physik der Atmosph{\"a}re, Oberpfaffenhofen, Germany}
\affil[19]{University of Bremen, Institute of Environmental Physics (IUP), Bremen, Germany}
\affil[20]{University of Trento, Trento, Italy}
\affil[21]{Centre for Environmental Data Analysis (CEDA), RAL Space, Oxfordshire, UK}
%---
...
\correspondence{Paul J. Durack (pauldurack@gmail.com; paul.durack@uwa.edu.au)}
...
\firstpage{1}
\maketitle
\enlargethispage{1.5cm}  %% extend vertical length of page so Correspondence can fit
\section*{Correspondence}
Paul J. Durack (pauldurack@gmail.com; paul.durack@uwa.edu.au)
...
\begin{itemize}
  ...
  \item Gavin's AR5/CMIP5 summary doc - https://www.giss.nasa.gov/staff/gschmidt/ar5-wkshp-white-paper.pdf  
\end{itemize}
} %% end\cred
...
To provide context for the \cred{most recent completed phase \citep[CMIP6;][]{eyring_overview_2016} and the planning of the project’s future (Add Dunne et al., 2025)}, we discuss the efforts dating back to the MIP origins and their contribution to making climate community collaboration what it is today. Small teams or individuals initiated many of the steps taken. While evidence of this history is scattered in the literature, we attempt to bring them together to tell a coherent story of how CMIP got to where it is today. Our emphasis details the pragmatics of what it took to progressively scale up efforts, most recently delivering CMIP6. Thus, this review describes the evolution of how the MIPs were implemented and the coordinated efforts to establish a minimal infrastructure to make that possible.
...
\begin{figure*}
    ...
    \includesvg[width=\textwidth]{260524T112445_Fig1.svg}
...
\begin{figure*}
    \centering
    \includesvg[width=\textwidth]{260524T112445_Fig2.svg}
    \caption{Growth of the CMIP6 project over time, with data sizes (PB) identified by colours for each of the CMIP6 endorsed MIPs (see \autoref{tab:tab2-CMIP6MIPs}) from the initial date of data publication (9th May 2018) through to the \cred{last/latest publication (17 April 2025)}. The legend denotes MIP project sizes in Terabytes (TB). The largest data contributions in CMIP6 are from the CMIP (light blue) and ScenarioMIP (dark grey) activities, comprising 8.4 PB of the >15 PB total. Data growth fluctuated throughout the project's life, with \cred{current 2024 publication rates of 2.1 PB/yr (prorated)}. This compares to previous years: 0.8 in 2023, 3.3 in 2022, 1.8 in 2021, 3.1 in 2020, 3.3 in 2019, and 0.1 PB in 2018.}
...
\begin{figure*}
    \centering
    \includesvg[width=\textwidth]{260524T112445_Fig3.svg}
    \caption{Web of Science (WoS) citations for key overview papers of each MIP phase, from FANGIO \citep{cess_intercomparison_1990} through CMIP6 \citep{eyring_overview_2016}, plotted relative to their year of publication (WoS records queried 23 May 2026). For CMIP6, citations are plotted for the project overview paper \citep{eyring_overview_2016}, for the cumulative total across each of the satellite Community MIPs that comprise the phase (see \autoref{tab:tab2-CMIP6MIPs}), and for the composite sum of these two sources. Citation counts are an imperfect way to capture MIP impact but reflect a large and strongly growing user community using MIP data across numerous phases.}
...
\begin{figure*}
    \centering
    \includesvg[width=\textwidth]{260524T112445_Fig4.svg}
    \caption{Web of Science (WoS) citations for the 23 endorsed MIP overview papers contributing to CMIP6 (see \autoref{tab:tab2-CMIP6MIPs}) from their publication to today (WoS records queried 23 May 2026). Black text numbers on each coloured bar denote citation counts. Citation counts are an imperfect way to capture MIP impact, however, reflect the large interest in the ScenarioMIP future climate change projections \citep{oneill_scenario_2016} and the HighResMIP high-resolution simulations \citep{haarsma_high_2016}.}
...
\begin{figure*}
    \centering
    \includesvg[width=\textwidth]{260524T112445_Fig5.svg}
...
\begin{table*}[htp]
	...
	\resizebox{\textwidth}{!} {
		\begin{tabularx}{0.9\textwidth} {
			...
			CMIP1 & \citet{meehl_global_1995} & \textbf{CMIP:} pdcntrl & 
            \href{https://doi.org/10.1175/1520-0477-76.6.951}{10.1175/1520-0477-76.6.951};
            \url{https://web.archive.org/web/19970824235843/http://www-pcmdi.llnl.gov/cmip/Cmip.htm}\\ \hline
			CMIP2 & \citet{meehl_intercomparison_1997} & \textbf{CMIP:} pdcntrl, picntrl, 1pctCO2 &
            \href{https://doi.org/10.1029/97EO00276}{10.1029/97EO00276};         \url{https://web.archive.org/web/19970825000210/http://www-pcmdi.llnl.gov/cmip/announ.htm}\\ \hline
			CMIP3 & Doutriaux \& Taylor, 2005; \citet{meehl_wcrp_2007} & \textbf{CMIP:} 1pctto2x, 1pctto4x, 20C3M, amip, pdcntrl, picntrl; \textbf{CFMIP:} 2xco2, slabcntl; \textbf{ScenarioMIP:} commit, SRESA1B, SRESA2, SRESB1 &

            \href{https://doi.org/10.5281/zenodo.12792173}{10.5281/zenodo.12792173};
            \href{https://doi.org/10.1175/BAMS-88-9-1383}{10.1175/BAMS-88-9-1383};            \url{https://pcmdi.llnl.gov/mips/cmip3/experiment.html\#Experiments}\\ \hline
			CMIP5 & \cite{taylor_cmip5_2011,taylor_overview_2012}; Doutriaux \& Taylor, 2013 & \textbf{CMIP:} 1pctCO2, abrupt4xCO2, amip, historical, piControl; \textbf{C4MIP:} esmControl, esmFdbk1, esmFdbk2, esmFixClim1, esmFixClim2, esmHistorical, esmrcp85; \textbf{CFMIP:} amip4K, amip4xCO2, amipFuture, aqua4K, aqua4xCO2, aquaControl, sst2030 \textbf{DCPP:} decadalXXXX, noVolcXXXX, volcIn2010; \textbf{DAMIP:} historicalExt, historicalGHG, historicalMisc, historicalNat; \textbf{PMIP:} lgm, midHolocene, past1000; \textbf{RFMIP:} sstClim, sstClim4xCO2, sstClimAerosol, sstClimSulfate; \textbf{ScenarioMIP:} rcp26, rcp45, rcp60, rcp85 &
            
            \href{https://doi.org/10.5281/zenodo.14195394}{10.5281/zenodo.14195394}; \href{https://doi.org/10.1175/BAMS-D-11-00094.1}{10.1175/BAMS-D-11-00094.1}; \href{https://doi.org/10.5281/zenodo.12792191}{10.5281/zenodo.12792191};            
            \url{https://pcmdi.llnl.gov/mips/cmip5/experiment\_design.html}\\ \hline			
			CMIP6 & \citet{eyring_overview_2016}; \citet{durack_cmip6_2024} & $\sim$190 (2016) to 322 (2024) see CMIP6\_CVs; for MIPs contributing to the phase see \autoref{tab:tab2-CMIP6MIPs} & 
            \href{https://doi.org/10.5194/gmd-9-1937-2016}{10.5194/gmd-9-1937-2016};
            \href{http://doi.org/10.5281/zenodo.12197150}{10.5281/zenodo.12197150}; \url{https://github.com/WCRP-CMIP/CMIP6\_CVs}; \url{https://wcrp-cmip.github.io/CMIP6\_CVs/docs/CMIP6\_experiment\_id.html}\\
			\hline		
		\end{tabularx}
	} % /resizebox
...
\begin{figure*}
    \centering
    \includesvg[width=\textwidth]{260524T112445_FigA1.svg}
...
\begin{figure*}
    \centering
    \includesvg[width=\textwidth]{260524T112445_FigB1.svg}
...
\mycomment{
%%##### COMMENTS %#####
Additional packages - https://github.com/NOAA-GFDL/fremor
Other CMOR users
- https://github.com/PCMDI/cmor/issues (authors)
- https://github.com/PCMDI/cmor/graphs/contributors
