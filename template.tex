...
Prior to CMIP5, PCMDI and its collaborators had alone been responsible for managing all the data distribution responsibilities for AMIP and CMIP.  In CMIP5 PCMDI the growth of the project demanded a more distributed support of the infrastructure.  For the purpose of coordinating the technical aspects of CMIP, the WGCM established the WGCM Infrastructure Panel (WIP), which works in parallel and colloaboration with the CMIP Panel to ensure that CMIP data is made widely available.  It was responsible for maintaining standards and policies for model data sharing.  They would be expected to endorse software implementations that support the standards.  This group would serve as a counterpart to the CMIP Modeling Panel and would allow the modeling groups, through the WGCM, to maintain some internal control over the technical requirements imposed by the increasingly burdensome MIPs.   
...
SLCF Hoesly et al., 2018; Feng et al., 2020
Biomass burning van Marle et al.,2017
Land use Hurtt et al., 2020; Chini et al., 2021
GHGs Meinshausen et al., 2017
Volcanic SAOD e.g. Aubry et al., 2019; Aubry et al., 2021; Aubry et al., 2023
Ozone Checa-Garcia et al., 2018
Nitrogen deposition Hegglin et al., 2016 (ESGF)
Solar Matthes et al., 2017
AMIP Durack \& Taylor, 2018
Aerosol optical Stevens et al., 2017, e.g., Fiedler et al., 2019
