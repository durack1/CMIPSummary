...
\mycomment{
Veronika E alternate: The Coupled Model Intercomparison Project (CMIP): Reviewing project history, evolution, and infrastructure
...
\Author[13]{Martin}{Juckes} % 0000-0003-1770-2132
...
\affil[13]{University of Oxford, and UK Research and Innovation (UKRI) Science and Technology Facilities Council (STFC), Oxfordshire, UK}
...
\cred{
\begin{itemize}
    \item \textbf{\sout{Jiwoo Lee}, \sout{Curt Covey}, \underline{Jeff Painter}, Ken Sperber, Ben Santer, Charles Doutriaux, Tom Phillips, PCMDI}: (\autoref{sec:cmip6InContext}: A/CMIP history, \autoref{sec:CMIP6SupportingProjects-CoordEval}: Coordinated evaluation);
    \item \textbf{\underline{Martin Juckes, STFC}} (\autoref{sec:CMIP6DR}: Variable request and standard output);
...
\cred{
\begin{itemize}
    \item \textbf{\underline{Jerry Meehl, Ron Stouffer}} (CMIP Panel, long-term leadership);
    \item \textbf{\sout{Curt Covey}, \underline{Gerry Potter}, \underline{Dave Bader}} (DOE/PCMDI);
    \item \textbf{\underline{Dean Williams}, \underline{Bryan Lawrence}, \underline{Jonathan Gregory}} (\autoref{sec:CMIPSupportingOrgsAndInfra}: ESGF/CF);
    \item \textbf{\underline{Vaishali Naik}, \underline{Jean-Francois Lamarque}, \underline{Veronika Eyring}}; (\autoref{sec:CMIP6SupportingProjects-input4MIPs}: forcing data CMIP5 through CMIP6);
    \item \textbf{\underline{Bryan Lawrence}, Balaji V., \underline{Sebastien Denvil}, \underline{Luca Cinquini}, Mark Elkington, \underline{Eric Guilyardi}, Michael Lautenschlager, \underline{Ruth Petrie}, \underline{Dean Williams}}: WIP Panel
    \item \cblue{\textbf{Paul:}} \textbf{\sout{Curt Covey}, \underline{Jerry Meehl}, \underline{Ron Stouffer}, \underline{Veronika Eyring}, \underline{Jean-Francois Lamarque}, Cath Senior, Greg Flato, Sandrine Bony, Bjorn Stevens}: CMIP Panel
    \item \cblue{\textbf{Paul:}} \textbf{Ghaleb Abdulla, Michael Lautenschlager, \underline{Sasha Ames}, \underline{V. Balaji}, Laura Carriere, Ben Evans, Robert Ferraro, \underline{Phil Kershaw}, \underline{Stephan Kindermann}, Tom Landry, \underline{Guillaume Levavasseur}, \underline{Forrest Hoffman}}: ESGF-XC; \textbf{Jay Hnilo, Sylvie Joussaume, Tsengdar Lee, Ben Evans, Annarita Mariotti}: ESGF-SC;    
\end{itemize} 
}
...
\mycomment{
%%##### COMMENTS %#####
Dave B 241120: I think the CMIP3 section understates the transformational change that occurred in data availability and distribution.
Susan Solomon, WGI head, asked WGCM chairs John Mitchell and ?? (maybe J. Meehl) to prepare an archive of standard model experiments for use by the, and this is critical, the WG1 community. And, as you would have expected, WGCM then asked PCMDI  to take the lead. After talking to Dean, I responded “yes” with two requirements – the data needed to be in standardized format before being sent to PCMDI and that the users were expected to be familiar with the data and its format.
Standardization of output format (Karl and Peter G.) and standing up the ESGF data server to have all of the CMIP3 data on line and in one place.  (Dean, Bob and Jenny) was not done in AMIP or CMIP before CMIP3. 
The WGCM’s best guess at the time was that the data would be accessed by 50 users and the data volume would be ~17 TBytes. You know the rest of the story.
%#####
}
...
\cred{\textbf{Attn: Bryan L. GO-ESSP initiated in 2003, I can only find an archived website - how does this relate to ESGF? You, Michael, Balaji, Dean, Don, etc all listed. Would be useful to get your take}}
...
\cred{Karl? Dean? to describe the CMIP6 era of ESGF: The ESGF success in delivering CMIP5 led to the CMIP6 planning that began in 2013. WGCM17 - also \citep{kershaw_esgf_2020} which laid out plans for an architecture overhaul - and \citep{pascoe_documenting_2020} which lays out how the data challenges etc went - fortify the CMIP5-era systems to make CMIP6 a success}
...
\label{sec:IS-ENES}
\cblue{\textbf{Karl/Paul to draft}}

In parallel to the building coordination across institutions and agencies in the US (see \autoref{sec:earthSystemGridFederation}), a similar coordinated approach was being developed across CMIP contributing institutions and agencies across Europe. The InfraStructure for the European Network for Earth System modelling (IS-ENES) consortium was officially established in March 2009 supported by the European Commission Capacities Programme.

Over three phases of the project, extending from 2009 through 2023, the project coordinated the activities of X contributing institutions across 15 countries.

Goals: The project aimed to coordinate European activities across climate modelling, computer science, data management, climate impacts and climate services

Outputs: 

\cred{Do we have written materials for this, note \url{https://is.enes.org/objectives}, see also \url{https://is.enes.org/isenes-phase-1-project}, \url{https://is.enes.org/isenes-phase-2-project}, \url{https://is.enes.org/partners}}

\cred{
\begin{itemize}
	\item Pursue the integration of the Earth’s climate system modelling community and prepare the sustainability of its infrastructure
	\item Foster the common development of models and tools, and the efficient use of High-Performance Computing
	\item Support the exploitation of model data by the Earth system science community, the climate change impact community and the climate service community
\end{itemize}
}
