...
\begin{itemize}
    ...
    \item \cblue{\textbf{Paul:}} \textbf{Sebastien Denvil, Ruth Petrie, CDNOT}: (\autoref{tab:tab1-MIPsThroughTime}/ESGF)
\end{itemize}
}
...
\cred{
\begin{itemize}
    \item \cblue{\textbf{Paul:}} \textbf{Jerry Meehl, Ron Stouffer} (CMIP Panel, long-term leadership);
    \item \textbf{\sout{Curt Covey}; \cblue{\textbf{Paul:}} Gerry Potter, Dave Bader} (DOE/PCMDI);
    \item \cblue{\textbf{Karl:}} \textbf{Dean Williams, Bryan Lawrence, Jonathan Gregory, ESGF-XC membership?} (\autoref{sec:CMIPSupportingOrgsAndInfra}: ESGF/CF);
    ...
    \item \cblue{\textbf{Paul:}} \textbf{Bryan Lawrence, Balaji V., Sebastien Denvil, Luca Cinquini, Mark Elkington, Eric Guilyardi, Michael Lautenschlager, Ruth Petrie, Dean Williams}: WIP Panel
\end{itemize} 
}
...
\cblue{\textbf{TO BE FINALIZED - Karl this would benefit from you taking a pass at this text - Wed 20 Nov}}
