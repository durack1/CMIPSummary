...
\begin{itemize}
    ...
    \item \textbf{\underline{Bryan Lawrence}, Balaji V., \underline{Sebastien Denvil}, \underline{Luca Cinquini}, Mark Elkington, \underline{Eric Guilyardi}, \underline{Michael Lautenschlager}, \underline{Ruth Petrie}, \underline{Dean Williams}}: WIP Panel
    \item \cblue{\textbf{Paul:}} \textbf{\sout{Curt Covey}, \underline{Jerry Meehl}, \underline{Ron Stouffer}, \underline{Veronika Eyring}, \underline{Jean-Francois Lamarque}, Cath Senior, Greg Flato, Sandrine Bony}: CMIP Panel
    \item \cblue{\textbf{Paul:}} \textbf{Jay Hnilo, Sylvie Joussaume, Tsengdar Lee, Ben Evans, Annarita Mariotti}: ESGF-SC; \textbf{Ghaleb Abdulla, \underline{Michael Lautenschlager}, \underline{Sasha Ames}, \underline{V. Balaji}, Laura Carriere, Ben Evans, Robert Ferraro, Phil Kershaw, Stephan Kindermann, Tom Landry, \underline{Guillaume Levavasseur}}: ESGF-XC    
\end{itemize} 
}
