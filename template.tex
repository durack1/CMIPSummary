...
\Author[2]{Michael}{Lautenschlager} % no ORCID, move to acknowledgements
...
\Author[1,\textdagger]{Dean N.}{Williams}
...
\begin{itemize}
    ...
    \item CMIP6 closure, CMIP6Plus continuation as interim phase, allowing MIPs to continue to leverage infrastructure while preparation for CMIP7 occurs (with infrastructure overhaul)
