...
\resizebox{\textwidth}{!} {
	\begin{tabularx}{0.9\textwidth} { 
	  ...
	  | >{\centering\arraybackslash\hsize=.1\hsize}X | }
\hline
\textbf{CMIP Phase} & \textbf{Temporal coverage} & \textbf{Source} & \textbf{URL} \\ \hline
CMIP3 & 2004-2008 & PCMDI, LLNL & - \\ \hline
...
\section{\cred{CMIP downstream data services}}  %% Appendix E
\label{sec:secAppE1-CMIPDownstreamServices}

\cred{The sustained CMIP development across multiple phases, along with publicly open data access since CMIP3 \autoref{sec:cmip3}, facilitated numerous downstream tools, and service developments which repackage and reformulate CMIP output for science use. In addition, non-ESGF data repositories are also now available, facilitating broad data access. A non-exhaustive list of several examples is included in \autoref{tab:secAppE1-CMIP6DownstreamServices}}
...
KNMI Climate Explorer & CMIP3, CMIP5, CMIP6, plus others & \url{https://climexp.knmi.nl} & \cred{\cite{durack_cmip6_2024}} & - \\ \hline
The U.S. Climate Resilience Toolkit CLIMATE EXPLORER & CMIP5 & \url{https://crt-climate-explorer.nemac.org} & - & - \\ \hline
PANGEO & CMIP3, CMIP5, CMIP6 & \url{https://pangeo-data.github.io/pangeo-cmip6-cloud/}; \url{https://registry.opendata.aws/cmip6/} & \cite{abernathey_cmip6_2020} & - \\ \hline
