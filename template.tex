...
The CMIP project has realized the potential of open-access data enabling science discovery and reproducibility and has become a de facto standard for the distributed Community MIPs to organize their science and cross-institutional collaborations. Therefore, The CMIP-supporting infrastructure is now being relied upon more and more to facilitate and enable coordinated climate science. Anyone CMIP-contributing modeling group can design an experimental protocol and, through existing relationships and connections, engage a dozen or more like-minded researchers to tackle the problem using a multi-model framework \citep[e.g.][]{jones_c4mip_2016}.
