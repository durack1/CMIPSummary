...
\begin{itemize}
  ...
  \item Realization that no one modelling system can accurately simulate the complexity of Earth, and so with approximations/parameterizations, there is a need to cross-check assumptions using a multi-model approach
...
\sout{\textbf{Jiwoo} (Shared - Coordinated evaluation)}, \textbf{Martina S} (Data citation), \textbf{Guillaume L/Atef B.-N.} (Data errata), \textbf{David H./Eric G.} (Model (and data) documentation).
\textbf{Dean W.} (ESGF), \textbf{Bryan L.} (ESGF), ESGF-XC membership?.
\textbf{Jerry M., Ron S.; Broader panel} (CMIP Panel).
...
\textbf{Host infrastructure} & PCMDI FTP & PCMDI FTP & PCMDI FTP & PCMDI FTP & PCMDI FTP; ESG-CET & ESGF, \cred{41} nodes & ESGF, \cred{30} nodes & ESGF, \cred{$\sim$8} nodes\\ \hline
...
\citep{eyring_assessment_2006,waugh_quantitative_2008,eyring_esmvaltool_2016,eyring_taking_2019,righi_earth_2020}
Gleckler et al., 2008
\citep{gleckler_performance_2008}

Coordinated MIP activities led to coordinated community evaluation by the participants, but the concept of coordinated evaluation around the larger CMIP project, or even the CMIP DECK was not something that had been done previously.
...
\hline
20C3M & CMIP 20th Century Climate in Coupled Models pilot project (now known as CMIP historical experiment) \\
\hline
...
\hline
C4MIP & CMIP Coupled Climate-Carbon Cycle MIP \\
\hline
CFMIP & CMIP Cloud Feedbacks MIP (Also CFMIP1, CFMIP2, and CFMIP3 \\
\hline
CLIVAR & WCRP Climate Variability and Predictability Core Project \\
\hline
...
\hline
DCPP & Decadal Climate Prediction Project (CMIP6 Community MIP, and WCRP ESMO Working Group) \\
\hline
...
\hline
ESMO & WCRP Earth System Modelling and Observations Core Project \\
\hline
...
\hline
NERSC & US Department of Energy Research Scientific Computing Center \\
\hline
NOAA & US National Oceanic and Atmospheric Administration \\
\hline
PMIP & CMIP Paleoclimate MIP (also PMIP1, PMIP2, PMIP3, and PMIP4 \\
\hline
...
\hline
WIP & WCRP WGCM Infrastructure Panel \\
\hline
