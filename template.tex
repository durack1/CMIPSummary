...
\Author[19,3\textdagger]{Sandro}{Fiore} % 0000-0002-8430-6087
...
\Author[16,4]{Jonathan M.}{Gregory} % 0000-0003-1296-8644
\Author[20,14]{Philip}{Kershaw} % 0000-0002-7646-291X
...
\affil[3]{CMCC Foundation - Euro-Mediterranean Center on Climate Change (CMCC), Lecce, Italy}
...
\begin{figure*}
    ...
    \caption{Web of Science citations for key overview papers of each MIP phase, from FANGIO \citep{cess_intercomparison_1990} through CMIP6, plotted relative to their year of publication. For CMIP6, citations are plotted for the project overview paper \citep{eyring_overview_2016}, for the cumulative total across each of the satellite Community MIPs that comprise the phase (see \autoref{tab:tab2-CMIP6MIPs}), and for the composite sum of these two sources. Citation counts are an imperfect way to capture MIP impact but reflect a large and strongly growing user community using MIP data across numerous phases.}
...
\cred{
CMIP6 is the latest in a long history of internationally coordinated and scientifically collaborative climate model-based research projects. The project has developed standard approaches to evaluate and intercompare climate models and a standardised infrastructure delivering these data to a broad and expanding community. This arrangement ensures that projections of future climate conditions are based on a robust and consistent framework. The progress embedded in the phase marks 35 years since coordinated MIP activities began at an informal meeting of experts focused on modelling standards and intercomparison of climate models in Boulder, Colorado, August 1989, becoming the first MIP, AMIP1 \citep{gates_amip_1991}. Since this foundational work, MIPs have captivated and engaged a broad and growing community and had a tangible impact, improving our knowledge of Earth's climate system and our ability to quantify and attribute the drivers and responses of the observed climate changes we are experiencing today.
}

\cred{
CMIP has generated profound insights and information that define how we understand and address climate change. It has improved climate prediction, provided quantified insights guiding policy and decision-making, informed risk and adaptation strategies and climate change mitigation planning, improved public awareness and climate education, and provided quantitative insights to help best inform and allocate international climate finance.
}

\cred{
While the project has been a demonstrable success, focused on the dual goals of facilitating the climate research community
}

\cred{
Like in past CMIP phases, this, in part, will target the expected needs of the upcoming IPCC AR7 cycle, but is also 
}

\cred{
Following the CMIP6 broad expansion, CMIP7 will likely further federate discrete activities and encompass climate model simulations from an even broader contributor pool. Infrastructure providers are undertaking considerable updates to modernize the supporting hardware and software for project delivery to facilitate the transition. In preparation for the transition, continued publications to the CMIP6 archive will cease in early 2025, with the project sunsetting soon after that. CMIP6 data will continue to be made available through the federated ESGF network. However, the priority for data curation and maintenance will shift in favor of CMIP7 soon after the first datasets become available.
}

\cred{
The CMIP project has been a cornerstone of modern climate science, enabling better predictions of future climate conditions, fostering international collaboration, guiding policy and adaptation strategies, and raising awareness of the urgent need for global action on climate change. Its contributions have touched nearly every aspect of society, from science and policy to the economy and the environment, playing a pivotal role in the fight against climate change.
}
...
\cred{John D.: As planning continues for the 7th phase of CMIP \citep{dunne_climate_2023}, it draws from a rich legacy of international cooperation and increasing community engagement with lessons learned from decades of dedicated efforts to optimize the value and utility of model data for climate model systematic evaluation and diverse applications.}
