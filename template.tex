...
\sout{\textbf{Jiwoo} (Shared - Coordinated evaluation)}, \textbf{Martina S} (Data citation), \textbf{Guillaume L/Atef B.-N.} (Data errata), \textbf{David H./Eric G.} (Model (and data) documentation), \textbf{Gerry P., Dave B.} (DOE/PCMDI)
...
\textbf{Jerry M., Ron S.; Broader panel past} (CMIP Panel).
...
\cred{Coordinated activities, ESMO benefits from model side well organized, no organize obs. Obs community have model targets to aspire to aid, higher resolution observations - observations for the purpose of model evaluation}
