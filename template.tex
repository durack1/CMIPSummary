...
\cred{
\begin{itemize}
    \item \textbf{\sout{Jiwoo Lee, PCMDI}} (\autoref{sec:CMIP6SupportingProjects-CoordEval}: Coordinated evaluation);
    ...
    \item \textbf{Vaishali Naik}: (\autoref{sec:CMIP6SupportingProjects-input4MIPs} forcing);
