...
\affil[11]{Deutsches Zentrum f\"ur Luft- und Raumfahrt (DLR), Institut f\"ur Physik der Atmosphäre, Oberpfaffenhofen,Germany}
...
\begin{itemize}
  ...
  \item VALE Larry Gates (acknowledgements?)
\end{itemize}
} %% end\cred
...
\begin{itemize}
    ...
    \item \textbf{Martin Juckes, STFC} (\autoref{sec:CMIP6DR}: Variable request and standard output);
...
\textbf{Host infrastructure} & PCMDI FTP & PCMDI FTP & PCMDI FTP & PCMDI FTP & PCMDI FTP; ESG-CET & ESGF, 31 nodes & ESGF, 30 nodes & ESGF\\ \hline
...
\cred{Karl? Dean? to describe the CMIP6 era of ESGF: The ESGF success in delivering CMIP5 led to the CMIP6 planning that began in 2013. WGCM17}
