...
\begin{itemize}
    ...
    \item \cblue{\textbf{Karl:}} \textbf{Dean Williams, \underline{Bryan Lawrence}, Jonathan Gregory} (\autoref{sec:CMIPSupportingOrgsAndInfra}: ESGF/CF);
    \item \cblue{\textbf{Paul:}} \textbf{\underline{Vaishali Naik}, Jean-Francois Lamarque, Veronika Eyring}; (\autoref{sec:CMIP6SupportingProjects-input4MIPs}: forcing data CMIP5 through CMIP6);
    \item \cblue{\textbf{Paul:}} \textbf{\underline{Bryan Lawrence}, Balaji V., \underline{Sebastien Denvil}, Luca Cinquini, Mark Elkington, Eric Guilyardi, Michael Lautenschlager, \underline{Ruth Petrie}, Dean Williams}: WIP Panel
    \item \cblue{\textbf{Paul:}} \textbf{\sout{Curt Covey}, \underline{Jerry Meehl}, \underline{Ron Stouffer}, Veronika Eyring, Jean-Francois Lamarque, Cath Senior, Greg Flato, Sandrine Bony}: CMIP Panel
    \item \cblue{\textbf{Paul:}} \textbf{Jay Hnilo, Sylvie Joussaume, Tsengdar Lee, Ben Evans, Annarita Mariotti}: ESGF-SC; \textbf{Ghaleb Abdulla, Michael Lautenschlager, \underline{Sasha Ames}, V. Balaji, Laura Carriere, Ben Evans, Robert Ferraro, Phil Kershaw, Stephan Kindermann, Tom Landry, \underline{Guillaume Levavasseur}}: ESGF-XC    
\end{itemize} 
}
