...
AMIP made model output available to analysts with diverse expertise, opening up possibilities for more in-depth and systematic model evaluation.   It established a benchmark against which new and possibly improved models could be evaluated. Emphasis was on the simulated mean climate and variability on global and regional scales. The goal was to document systematic errors as had never been done before through diagnostic subprojects, and to andvance the analysis of simulated physical process and phenomena \citep{gates_ams_1992}. 
