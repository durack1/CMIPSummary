...
\Author[8,5\textdagger]{Sebastien}{Denvil} % 0000-0002-6715-3533
...
\Author[13]{Fabrizio}{Antonio} % 0000-0002-7693-0111
\Author[1]{David C.}{Bader} % 0000-0003-3210-339X
\Author[14]{Daniel}{Ellis} % 0000-0001-6733-7028
\Author[15,16]{Veronika}{Eyring} % 0000-0002-6887-4885
\Author[17,13\textdagger]{Sandro}{Fiore} % 0000-0002-8430-6087
\Author[5,7]{Sylvie}{Joussaume} % 0000-0002-1510-3964
\Author[18,12]{Philip}{Kershaw} % 0000-0002-7646-291X
\Author[2\textdagger]{Jean-Francois}{Lamarque} % 0000-0002-4225-5074
\Author[9\textdagger]{Michael}{Lautenschlager} % no ORCID, no reply, move to acknowledgements
...
\Author[13]{Paola}{Nassisi} % 0000-0003-2857-4391
\Author[13]{Alessandra}{Nuzzo} % 0000-0002-8801-6917
\Author[1\textdagger]{Jeffrey}{Painter} % 0000-0001-7920-4337
\Author[1\textdagger]{Gerald L.}{Potter} % 0000-0003-0291-7229
\Author[5,6]{Sven}{Rodriguez} % ?
\Author[19\textdagger]{Dean N.}{Williams} % ?
...
\affil[12]{UK Research and Innovation (UKRI) Science and Technology Facilities Council (STFC), Oxfordshire, UK}
%---
\affil[13]{CMCC Foundation - Euro-Mediterranean Center on Climate Change (CMCC), Lecce, Italy}
\affil[14]{CMIP International Project Office (CMIP-IPO); European Space Agency (ESA), Oxfordshire, UK}
\affil[15]{Deutsches Zentrum f{\"u}r Luft- und Raumfahrt (DLR), Institut f{\"u}r Physik der Atmosph{\"a}re, Oberpfaffenhofen, Germany}
\affil[16]{University of Bremen, Institute of Environmental Physics (IUP), Bremen, Germany}
\affil[17]{University of Trento, Trento, Italy}
\affil[18]{Centre for Environmental Data Analysis (CEDA), RAL Space, Oxfordshire, UK}
%\affil[19]{SilverLining, Washington, District of Columbia, USA}
\affil[19]{Earth System Grid Federation (ESGF), Livermore, California, USA}
...
The CMIP6 project was the most expansive and ambitious Model Intercomparison Project (MIP). The project is the latest in a long MIP history, extending back four decades. CMIP has captivated and engaged a broad, growing community focused on improving our climate understanding. It has anchored our ability to quantify and attribute the drivers and responses of the observed climate changes we are experiencing today.

The project's profound impact has been achieved by combining the latest climate science and technology. This has enabled the production of the latest generation of climate simulations, which have seen increased community attention and impact in every successive phase.

This review discusses efforts dating back to MIP's origins and their contribution to making climate community collaboration what it is today. While evidence of this history is scattered in the literature, we attempt to bring it together to tell a coherent story of how CMIP got to where it is today.

\mycomment{The CMIP6 project was the most expansive and ambitious Model Intercomparison Project (MIP). Project planning began in 2013, with the first data available in 2018, and new data publication continues today. Over the planning to delivery period, the project grew from 21 to 26 MIPs and from around 190 to 322 experiments defined across them, providing comprehensive coverage of contemporary climate science. Project contributors, primarily modelling groups, also grew considerably in the latest phase, with 45 institutions representing 24 countries providing climate model simulation data to the project. Now that CMIP6 is nearing completion, we review its status, evolution over more than a decade of project planning and delivery, and opportunities and plans for future phases.}
...
CMIP6 is the latest in a long history of internationally coordinated and scientifically collaborative climate model-based research projects. The project has developed standard approaches to evaluate and intercompare climate models, and a standardised vocabulary and infrastructure that defined and delivered these data to a broad and expanding community. This arrangement ensures that projections of future climate conditions are based on a robust and consistent framework.

The progress embedded in the latest phase marks 35 years since coordinated MIP activities began at an informal meeting of experts focused on modelling standards and intercomparison of climate models in Boulder, Colorado, August 1989, becoming the first MIP, AMIP1 \citep{gates_amip_1991}. Since this foundational work, MIPs have captivated and engaged a broad and growing community and had a tangible impact, improving our knowledge of Earth's climate system.

CMIP has generated profound scientific insights that define how we understand and address climate change and our ability to quantify and attribute the drivers and responses of the observed climate changes we are experiencing today. It has improved climate prediction, provided quantified insights guiding policy and decision-making, informed risk and adaptation strategies and climate change mitigation planning, improved public awareness and climate education, and provided quantitative insights to help best inform and allocate international climate finance. Its contributions have touched nearly every aspect of society and raised awareness of the urgent need for global action on climate change.

While the project has been a demonstrable success, focused on the dual goals of facilitating the climate research community's undertaking of cutting-edge research and providing the latest climate data, enabling a broad array of activities, this growth and broadening community demands have strained existing research resources. This pressure is not new. After CMIP3, there were numerous calls for a reformulation of efforts to centralize resources across contributors to produce very high-resolution, regionally relevant climate predictions \citep{shukla_strategies_2009,shukla_toward_2010}. Towards the end of this most recent CMIP6 phase, similar calls have repeated \citep{jakob_need_2023,stevens_perspective_2024}.

To address these dual pressures, the WCRP created a CMIP International Project Office (CMIP-IPO) hosted by the European Space Agency (ESA, UK), commencing in March 2022. The CMIP-IPO is tasked with coordinating the development of the upcoming CMIP7 project (see \href{https://wcrp-cmip.org/cmip7}{https://wcrp-cmip.org/cmip7}) and facilitating the broad and growing CMIP contributor, and user communities. The project will target the expected IPCC AR7 cycle needs through a continued federation of activities, which began in CMIP6 \citep{eyring_overview_2016}. This aims to reduce modelling group burdens by better consulting the broad community, clarifying needs, and apportioning the limited resources to meet them. 

The CMIP project has had a sustained global impact. Its success has depended on the continuing efforts of tenacious individuals or small teams that initiated the steps facilitating community engagement. Coupled with the coordinated efforts within and across modelling groups, the infrastructure providers, and other contributors, these led to the broad community collaboration and coordination and CMIP's ongoing impact. At its core, the project is a fundamental anchor point of international climate research, facilitating modelling groups to generate the best possible simulations aiding climate change planning. In return, modelling groups benefit from coordinated collaborative activities and community evaluation, embodying the statement, "Intercomparison makes for a better climate model".
...
\begin{table*}[htp]
	...
	\footnotesize{Notes: In the CMIP5 phase, NOAA-GFDL submitted GFDL-HIRAM-C180 simulations for the CFMIP-motivated sst2090 and sst2090rcp45 experiments.}
...
\begin{figure*}
    ...
    \caption{Recorded downloads across the three phases of CMIP, for which download records are available, following \autoref{fig:fig5-MIPDownloads}. Left the top 6 CMIP3 experiment downloads across the 12 experiments that defined phase \citep{meehl_wcrp_2007}. Middle the CMIP5 downloads for the top 4 MIPs of the 8 that defined the phase \citep[\autoref{tab:tabAppA1-MIPExperiments};][]{taylor_overview_2012}. And right the CMIP6 downloads for the top 4 MIPs of the 22 that defined the phase \cite[[see \autoref{tab:tab2-CMIP6MIPs};][]{eyring_overview_2016}. For CMIP6, almost 50\% of downloads were accounted for by the core CMIP/DECK simulations, with more than 30\% accounted for in the ScenarioMIP future projection experiments \citep{oneill_scenario_2016}. This pattern of data download priority is mirrored across the prior phases, with an inversion in CMIP5 (ScenarioMIP 44\%, CMIP 41\%) and a more dominant 20C3M/picntrl demand in CMIP3 (CMIP 64\%, 35\% ScenarioMIP).}
