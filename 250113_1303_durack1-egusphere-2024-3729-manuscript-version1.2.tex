...
\affil[14]{Geophysical Fluid Dynamics Laboratory, National Oceanic \& Atmospheric Administration (NOAA-GFDL), Princeton, New Jersey, USA}
\affil[15]{CMIP International Project Office (CMIP-IPO); European Space Agency Centre for Space Applications \& Telecommunications (ESA-ECSAT), Oxfordshire, UK}
...
\firstpage{1}
\maketitle
\enlargethispage{0.25cm}  %% extend vertical length of page so Correspondence can fit
...
Work on optimizing data movement speeds was performed in a collaboration between ESnet and participating sites \citep{kettimuthu2010lessons}.
